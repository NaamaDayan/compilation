...
MALLOC rdx, 40 ;number of params
mov qword [r9], rdx
;copyParamsLoop:
;copyParamsLoop:
;copyParamsLoop:
...
mov qword rdx, [r9]
mov rbx, [rbp + 8*(4 + 16)] ;rbx = param(i)
mov [rdx + 16], rbx ;rdx = extEnv[0], rdx[i] = rbx 
mov qword rdx, [r9]
mov rbx, [rbp + 8*(4 + 24)] ;rbx = param(i)
mov [rdx + 24], rbx ;rdx = extEnv[0], rdx[i] = rbx 
mov qword rdx, [r9]
mov rbx, [rbp + 8*(4 + 32)] ;rbx = param(i)
mov [rdx + 32], rbx ;rdx = extEnv[0], rdx[i] = rbx 
